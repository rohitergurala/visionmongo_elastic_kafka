...
```
$ docker image tag visionmongoelastickafka rohitergurala/visionmongoelastickafka
$ docker push rohitergurala/visionmongoelastickafka
```
...
```
$ kubectl get svc visionmongoelastickafka
```
