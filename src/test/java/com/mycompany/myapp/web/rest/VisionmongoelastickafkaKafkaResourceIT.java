...
import com.mycompany.myapp.VisionmongoelastickafkaApp;
...
@SpringBootTest(classes = VisionmongoelastickafkaApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class VisionmongoelastickafkaKafkaResourceIT {
    ...
    @Autowired
    private VisionmongoelastickafkaKafkaProducer producer;

    @Autowired
    private VisionmongoelastickafkaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        VisionmongoelastickafkaKafkaResource kafkaResource = new VisionmongoelastickafkaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/visionmongoelastickafka-kafka/publish?message=test"))
